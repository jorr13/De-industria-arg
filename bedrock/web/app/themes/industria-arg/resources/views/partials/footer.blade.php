<footer class="content-info">
  <div class="containerfooter columns is-multiline">
    <div class="parteuna column is-5">
      <div class="primera-seccion column is-3">
        <div class="image-contenedor">
          <img class="ico-redes-blanco" src="{{ home_url('app/uploads/2018/08/DIA-logo-02.png') }} " alt="">
        </div>
